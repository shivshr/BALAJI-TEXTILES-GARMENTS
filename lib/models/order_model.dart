...
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:balaji_textile_and_garments/models/cart_item_model.dart';
import 'package:balaji_textile_and_garments/models/address_model.dart'; // ✅ user_model nahi
// ❌ REMOVE: import 'package:balaji_textile_and_garments/models/user_model.dart';
...
class OrderModel {
  ...
  final String userName;
  final List<CartItemModel> items;
  final AddressModel shippingAddress; // ✅ ab address_model.dart ka AddressModel
  final double subtotal;
  final double discount;
  final double shippingFee;
  final double totalPrice;
  ...
  factory OrderModel.fromMap(Map<String, dynamic> map) => OrderModel(
        ...
        items:           (map['items'] as List<dynamic>? ?? [])
            .map((e) => CartItemModel.fromMap(e))
            .toList(),
        // ✅ address_model.dart ka fromJson use karo
  ...
  Map<String, dynamic> toMap() => {
        ...
        'user_name':        userName,
        'items':            items.map((e) => e.toMap()).toList(),
        // ✅ address_model.dart ka toJson use karo
